...
export default function Home() {
  return (
    <section className="flex xl:flex-row items-center flex-col-reverse mt-10 lg:mt-32 overflow-hidden gap-10 xl:gap-0">
      <div className="absolute rounded-full h-[400px] w-[600px] md:h-[500px] md:w-[1000px] lg:h-[700px] lg:w-[1400px] top-52 bg-purple-200 bg-opacity-40 backdrop-blur-md -z-10 -right-48 md:-right-96"></div>
      ...
      <div className="w-full lg:w-3/5 flex justify-center items-center flex-col gap-2 sm:gap-7">
        <div className="text-center drop-shadow-xl selection:bg-pink-200 selection:text-slate-100 font-bold text-2xl sm:text-4xl xl:text-5xl xl2:text-7xl bg-gradient-to-b from-purple-900 to-purple-500 inline-block p-10 text-transparent bg-clip-text">
          با ما{" "}
        ...
        <div className="max-w-[400px] lg:max-w-[600px] flex justify-center text-base md:text-xl lg:text-2xl text-slate-700 bg-opacity-50 backdrop-blur-md rounded-md mb-10 selection:bg-pink-200">
