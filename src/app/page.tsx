...
export default function Home() {
  return (
    <section className="flex xl:flex-row items-center flex-col-reverse mt-10 lg:mt-32 overflow-hidden gap-10 xl:gap-0">
      <div className="absolute rounded-full h-[250px] w-[400px] md:h-[500px] md:w-[1000px] lg:h-[700px] lg:w-[1300px] top-52 bg-purple-200 bg-opacity-40 backdrop-blur-md -z-10 -right-48 md:-right-96"></div>
