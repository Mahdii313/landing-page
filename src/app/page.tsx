...
export default function Home() {
  return (
    <section className="flex xl:flex-row items-center flex-col-reverse mt-10 lg:mt-32 overflow-hidden gap-10 xl:gap-0">
      <div className="absolute rounded-l-full h-[250px] w-[208px] md:h-[500px] md:w-[808px] lg:h-[700px] lg:w-[1108px] top-52 bg-purple-200 bg-opacity-40 backdrop-blur-md -z-10 right-0 md:-right-96"></div>
      ...
      <div className="w-full lg:w-3/5 flex justify-center items-center flex-col gap-2 sm:gap-7">
        ...
        <div className="p-4 max-w-[400px] lg:max-w-[600px] flex justify-center text-base md:text-xl lg:text-2xl text-slate-700 mb-10 selection:bg-pink-200">
