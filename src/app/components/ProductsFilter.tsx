...
const ProductsFilter = () => {
  return (
    <div className="shadow-xl shadow-slate-300 rounded-xl py-5 pr-4 pl-6 border bg-pink-50 border-slate-300">
      <div className="flex items-center justify-between flex-row-reverse mb-5">
        <div className="mr-5 text-base sm:text-xl font-semibold text-purple-900">
          : نوع کالا
        </div>
        <ItemsList
          list={ProductsList}
